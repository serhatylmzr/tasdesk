    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advert_image', models.ImageField(blank=True, null=True, upload_to='')),
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='advert_likes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='views', to='adverts.Advert', verbose_name='İlan')),
            ],
        ),
        migrations.CreateModel(
            name='AdvertComment',
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('advert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='adverts.Advert', verbose_name='İlan')),
                ('user', models.ForeignKey(on_delete=False, to=settings.AUTH_USER_MODEL, verbose_name='Kullanıcı')),
            ],
        ),
    ]
